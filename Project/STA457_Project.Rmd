...
ggplot(testSet, aes(x = Time)) +
  geom_line(aes(y = month_Price, color = "Actual"), size = 1) +
  geom_line(aes(y = pred_price2, color = "Predicted"), size = 1) +
  geom_line(aes(y = pred_price_upper2), linetype = "dashed", color = "blue") +
  geom_line(aes(y = pred_price_lower2), linetype = "dashed", color = "blue") +
  labs(title = "Actual vs. Predicted Price with 95% Prediction Interval",
       x = "Time", y = "Price") +
  scale_color_manual(values = c("Actual" = "black", "Predicted" = "red")) +
  theme_minimal()
